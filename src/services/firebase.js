...
const firebaseConfig = {
    apiKey: "AIzaSyA2LoTTvPRjD_iQ0WB2ZDN591fxEu0L7BM",
    authDomain: "coffee-store-pereira.firebaseapp.com",
    projectId: "coffee-store-pereira",
    storageBucket: "coffee-store-pereira.appspot.com",
    messagingSenderId: "121843524418",
    appId: "1:121843524418:web:c76a223c85d09a39bc9edb"
};
...
// const prodRef = doc(db, "products", "4g0baWKOQaudhtsublFN");
...
//Usando Query (consulta banco)

// const q = query(collection(db, "products"), where("price", ">", 10))
// getDocs(q).then((snapshot) => {
//     console.log("snapshot: ", snapshot.docs);
//     if (snapshot.size === 0) console.log("empty");
//     snapshot.docs.forEach((item) => {
//         console.log("Item: ", item.data())
//     })
// })

// ---------- Populando o banco de dados do Firebase com os dados da API FakeCofee -----------
...
//     "grind_option": ["Whole Bean", "Cafetiere", "Filter", "Pour Over"],
//     "roast_level": 1,
